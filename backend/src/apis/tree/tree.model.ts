...
// const treeCords = await convertAddress(treeAddress)
    ...
    await sql`INSERT INTO tree (tree_id, tree_profile_id, tree_address, tree_end_date, tree_date, tree_image, tree_info, tree_lat, tree_lng, tree_title, tree_species) VALUES (${treeId}, ${treeProfileId}, ${treeAddress}, ${endDate()}, now(), ${treeImage}, ${treeInfo}, ${treeLat}, ${treeLng}, ${treeTitle}, ${treeSpecies})`
